...
from Helper_Functions import load_image_paths_zhong, load_image_paths_livecellminer, plot_loss, plot_losses, plotconfusionmatrx, setColorMap
...
parser.add_argument('--input_folder',type=str, default="home/roy/Rijo/08_Train_LiveCellMiner_class/Images/",help="Full path to the image sequences") #CellMorphology_ZhongNMeth

parser.add_argument('--out_path',type=str, default="results_folder",help="Will generate during the run")
...
parser.add_argument('--n_classes',type=int, default= 3, help="Number of label classes to be classified")
...
parser.add_argument('--train_to_test_ratio',type=float, default= 0.85 , help="Train to test ratio for LivecellMiner. Zhong testdataset is chosen by folder name")
...
parser.add_argument('--saved_model_path',type=str, default="/home/students/roy/Rijo/output/autoencoder_trained_17000.pth",help="Path of the saved model")
